...
class ConceptEmbeddingModel(ConceptBottleneckModel):
    ...
    def _forward(
        ...
        print('\nENTERED THE _FORWARD FUNCTION IN CEM.PY')
        ...
        if latent is None:
            ...
            if pre_c.isnan().any():
                ...
                print('INPUT = ', x)
                print('MODEL PARAMS = ')
                for name, param in self.pre_concept_model.named_parameters():
            ...
            for i, context_gen in enumerate(self.concept_context_generators):
                ...
                if context.isnan().any():
                    print('CONTEXT HAS NAN')
                    print('INPUT = ', pre_c)
                    print('MODEL PARAMS = ')
                    for name, param in context_gen.named_parameters():
                        if param.requires_grad:
                            print(name, param.data)
                ...
                if prob.isnan().any():
                    ...
                    print('INPUT = ', context)
                    print('MODEL PARAMS = ')
                    for name, param in prob_gen.named_parameters():
                        if param.requires_grad:
                            print(name, param.data)
        ...
        if output_interventions:
            print("OUTPUTTING INTERVENTIONS")
            if (
