...
# file_path = '/mnt/qb/work/bethge/bkr046/DATASETS/CUB_200_2011/class_attr_data_10/test.pkl'
...
#####
# Doing this so that the script imports the package 'cem' from this directory 
# instead of searching elsewhere
